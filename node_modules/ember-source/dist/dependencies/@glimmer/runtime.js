import { symbol, debugToString, Stack, assign, initializeGuid, fillNulls, _WeakSet, decodeHandle, isNonPrimitiveHandle, dict, unreachable, unwrapTemplate, EMPTY_ARRAY, isErrHandle, unwrapHandle, clearElement, isSmallInt, encodeImmediate, encodeHandle, constants, decodeImmediate, isHandle } from '@glimmer/util';
...
import { UNDEFINED_REFERENCE, valueForRef, createComputeRef, childRefFor, TRUE_REFERENCE, FALSE_REFERENCE, isConstRef, createPrimitiveRef, NULL_REFERENCE, createIteratorRef, createDebugAliasRef, updateRef, createIteratorItemRef } from '@glimmer/reference';
...
function curry$1(definition, args) {
...
, vm => {
  ...
  if (DEBUG && !isCurriedComponentDefinition(value)) {
    throw new Error(`Expected a curried component definition, but received ${value}. You may have accidentally done <${ref.debugLabel}>, where "${ref.debugLabel}" was a string instead of a curried component definition. You must use the {{component}} helper to create a component definition when invoking dynamically.`);
  }
...
function renderMain(runtime, context, self, treeBuilder, handle, dynamicScope = new DynamicScopeImpl()) {
