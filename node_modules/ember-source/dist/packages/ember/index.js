...
import { Checkbox, Component, setComponentManager, setHelperManager, capabilities, escapeExpression, getTemplates, Helper, helper, helperCapabilities, htmlSafe, invokeHelper, isHTMLSafe, LinkComponent, setTemplates, template, TextField, TextArea, isSerializationFirstNode, setModifierManager, modifierCapabilities, setComponentTemplate, getComponentTemplate } from '@ember/-internals/glimmer'; // eslint-disable-next-line import/no-unresolved
...
if (EMBER_EXTEND_PROTOTYPES) {
  Object.defineProperty(Ember, 'EXTEND_PROTOTYPES', {
    ...
    get() {
      deprecate('Accessing Ember.EXTEND_PROTOTYPES is deprecated, please migrate to Ember.ENV.EXTEND_PROTOTYPES', false, {
...
Ember.Engine = Engine;
Ember.EngineInstance = EngineInstance; // ****@ember/polyfills****

Ember.assign = assign;
Ember.merge = merge; // ****@ember/-internals/utils****
...
Ember._Backburner = Backburner; // ****@ember/-internals/console****
...
Ember.VERSION = VERSION; // ****@ember/-internals/views****

if (JQUERY_INTEGRATION && !views.jQueryDisabled) {
  Object.defineProperty(Ember, '$', {
    get() {
      deprecate("Using Ember.$() has been deprecated, use `import jQuery from 'jquery';` instead", false, {
