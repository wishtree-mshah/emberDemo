...
import { guidFor, getName, setName, makeArray, HAS_NATIVE_PROXY, HAS_NATIVE_SYMBOL, isInternalSymbol } from '@ember/-internals/utils';
import { meta } from '@ember/-internals/meta';
import { PROXY_CONTENT, sendEvent, Mixin, activateObserver, applyMixin, defineProperty, descriptorForProperty, classToString, isClassicDecorator, DEBUG_INJECTION_FUNCTIONS } from '@ember/-internals/metal';
...
class CoreObject {
  constructor(owner) {
    ...
    registerDestructor(self, () => self.willDestroy()); // disable chains
  ...
  */
  ...
  toString() {
    ...
    let ret = `<${getName(this) || getFactoryFor(this) || this.constructor.toString()}:${guidFor(this)}${extension}>`;
    return ret;
  }
  /**
